...
# default options
DOCKER=true
TEST_SCRIPT="yarn workspace @trezor/transport example:bridge"
...
yarn pbjs -t json -p ./trezor-common/protob -o ./packages/transport/e2e/messages.json --keep-case messages-bitcoin.proto messages-bootloader.proto messages-common.proto messages-crypto.proto messages-debug.proto messages-management.proto
